    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            <jsp:include page="../../includes/menu.jsp">
                ...
                <jsp:param name="permissionLeafNum" value="5"/>
            </jsp:include>
        </div>
    </div>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="#" onclick="roleListTable.addRoleInfo()" class="btn btn-default"
                                   id="datatable_ajax_new"><i class="fa fa-plus faa-shake animated-hover"></i>添加角色</a>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div id="datatable_ajax_column_toggler"
                                        ...
                                        <label><input type="checkbox" checked data-column="0">角色名称</label>
