                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input id="permToken" class="form-control " type="text" readonly
                                                           value="${permissionValues}" onclick="showMenuPerm();"/>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a id="menuBtn" href="#"
                                                       onclick="showMenuPerm(); return false;">选择</a>
                                                    <input id="permTokens" name="permTokens" type="hidden"/>
                                                    <input id="oldPermTokens" name="oldPermTokens" type="hidden" value="${permissionTokens}"/>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-offset-3 col-md-9">
                                                <input type="button" class="btn default green" value="保存"
                                                       id="saves" onclick=" roleListTable.editSave()"/>
                                                &nbsp
